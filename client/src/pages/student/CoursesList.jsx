...
const CoursesList = () => {
  ...
  useEffect(()=>{
    if(allCourses && allCourses.length>0){
      ...
      input? setFilteredCourse(tempCourses.filter(item=> item.courseTitle.toLowerCase().includes(input.toLowerCase())))
      : setFilteredCourse(tempCourses)
    }
  },[allCourses,input])
  return (
    <>
      <div className='relative md:px-36 px-8 pt-20 text-left bg-gradient-to-b from-blue-200/70'>
